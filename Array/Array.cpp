...
void Array::merge_sorted(Array a,Array b) //Merges sorted array in sorted order
{
    int i=0,j=0,k=0;
    size=a.size+b.size;
...
while(1)
 {
    ...
    cout<<"16. Perform merging of 2 arrays in sorted order"<<endl;
    cout<<endl;
